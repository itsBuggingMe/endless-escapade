    ...
    where T : struct
{
    ...
    static EntityQuery()
    {
        ComponentManager.AddEventListener_OnEntityComponentAdded(OnComponentAdded);
        ComponentManager.AddEventListener_OnEntityComponentRemoved(OnComponentRemoved);
    }
