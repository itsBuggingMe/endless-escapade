            ...
            foreach (var file in files)
            {
                switch (file.AssetType)
                {
                    case AssetType.Texture2D:
                        writer.WriteLine($"public static readonly ImageAsset {file.Name} = new(\"{file.Path}\");");
                        break;
                    case AssetType.Effect:
                        writer.WriteLine($"public static readonly EffectAsset {file.Name} = new(\"{file.Path}\");");
                        break;
                    case AssetType.SoundEffect:
                        writer.WriteLine($"public static readonly SoundAsset {file.Name} = new(\"{file.Path}\");");
                        break;
                }
            }
